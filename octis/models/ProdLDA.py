...
class ProdLDA(AVITM):
    def __init__(
        ...
        reduce_on_plateau=False, prior_mean=0.0, prior_variance=None,
        num_layers=2, num_neurons=100, num_samples=10, use_partitions=True):
        super().__init__(
            ...
            use_coherence_loss=use_coherence_loss,
